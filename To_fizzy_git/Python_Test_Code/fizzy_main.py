...
if DOWNLINK_MODE:
    fizzy.start_downlink()  # Enable continuous data streaming (~104 Hz)

# Get starting time
try:
    data = fizzy.get_data_downlink() if DOWNLINK_MODE else fizzy.get_data()
except:
    print("dropout")
...
g = 9.81  # acceleration of gravity in g
