...
from settingsHandGroundModel import OUTPUT_AMOUNT_HAND, INPUT_AMOUNT_HAND
...
class IMUNet(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = nn.Conv1d(INPUT_AMOUNT_HAND, 16, kernel_size=7, padding=3)
        ...
        self.fc = nn.Linear(32, OUTPUT_AMOUNT_HAND)
